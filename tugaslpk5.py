...
with tab2:
    ...
    with fourth_column:  
        ...
        st.write('2219080')
with tabx:
    st.subheader("Ada peribahasa, tak kenal maka tak sayang, sebelum kita memulai praktikum Analisis Fisika, alangkah baiknya jika kita berkenalan terlebih dahulu")
